...
| [Training-Builder.md](Training-Builder.md) | **The training builder**: author scenarios as mermaid diagrams (markdown ⇄ configuration, both directions), import from spreadsheet CSV, with a validation report on every conversion — Unity inspector buttons + Python CLI, one shared dialect. |
